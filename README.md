...
**Simple name:** StockScan

Kirana shop app: stock, sell, bills, WhatsApp, GST.

This is a Grok App Builder project. The sandbox npm name was `app-builder-workspace`. On GitHub it is **S.StockScan** (private).
...
```bash
cd "/Users/akshitpareta/Documents/S-projects/S.StockScan"
npm install
npm run dev
```
